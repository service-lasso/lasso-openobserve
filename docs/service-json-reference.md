...
Ref/code-backed donor health check types observed:
- `http`
- `tcp`
- `file`
- `variable`
...
### Observed donor health check types
The donor runtime/code shows these health check types:
- `http`
- `tcp`
- `file`
- `variable`
